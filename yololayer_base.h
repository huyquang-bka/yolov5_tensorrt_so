...
namespace Yolo
{
    ...
    static constexpr int CLASS_NUM = CLASS_NUM_REPLACE;
    static constexpr int INPUT_H = INPUT_H_REPLACE;  // yolov5's input height and width must be divisible by 32.
    static constexpr int INPUT_W = INPUT_W_REPLACE;
